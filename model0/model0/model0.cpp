// model0.cpp : Defines the entry point for the console application.
//
#include <stdlib.h>
#include <string.h>
#include <stdbool.h>
...
#define MAX_NUM_CHANNEL_MODE1 2
#define MAX_NUM_CHANNEL_MODE2 4

typedef int matrix[][BLOCK_SIZE];
	...
	else
	{
		...
		for (j = 0; j < BLOCK_SIZE; j++)
		{
			...
			*right_out = *right_in * dB2double;
			...
			processBlock(left_in, lsOutput, &tremolo, BLOCK_SIZE);
			*lsOutput = *left_out * dB2double;

			processBlock(right_in, rsOutput, &tremolo, BLOCK_SIZE);
			*rsOutput = *right_out * dB2double;
		}
	}
}
